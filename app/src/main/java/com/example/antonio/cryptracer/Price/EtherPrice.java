...
public class EtherPrice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ether_price);
        ...
        try {
            ...
            okHttpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    Toast.makeText(EtherPrice.this, "Error during BPI loading: " +
    ...
    private void load(String body){
        try {
            TextView txtView = findViewById(R.id.etherTxt);
