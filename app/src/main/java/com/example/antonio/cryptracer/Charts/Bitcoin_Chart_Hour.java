...
public class Bitcoin_Chart_Hour extends AppCompatActivity {

    public static final String API_CALL = "https://min-api.cryptocompare.com/data/histohour?fsym=BTC&tsym=USD&limit=24&aggregate=3&e=CCCAGG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bitcoin_chart_hour);
        run();
    }
    ...
    private void run(){
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(Bitcoin_Chart_Hour.this, "Error during data loading : "
    ...
    private void parseBpiResponse(String body){
        try{
            candleStickChart = (CandleStickChart) findViewById(R.id.hourly_chart  );
            ...
            CandleDataSet cds = new CandleDataSet(entries, "Hourly fluctuations for the last day");
