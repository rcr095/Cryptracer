...
public class EtherChart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ether_chart);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(EtherChart.this, "Error Loading Data" +
    ...
    public void buildChart(String data) {
        try {
            ...
            candleStickChart = findViewById(R.id.etherChart);
    ...
    public String getKey(String period){
        ...
        if(period.equals("year")) {
            String key = "https://min-api.cryptocompare.com/data/histoday?fsym=ETH&tsym=USD&limit=364&aggregate=3&e=CCCAGG";
            return key;
        } else if(period.equals("day")) {
            String key = "https://min-api.cryptocompare.com/data/histohour?fsym=ETH&tsym=USD&limit=24&aggregate=3&e=CCCAGG";
            return key;
        } else if(period.equals("hour")) {
            String key = "https://min-api.cryptocompare.com/data/histominute?fsym=ETH&tsym=USD&limit=60&aggregate=3&e=CCCAGG";
            return key;
        } else {
            return null;
        }
